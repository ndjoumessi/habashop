...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  chipLabel: { fontSize: FontSize.xs, fontFamily: 'Geist_600SemiBold', color: C.text3, textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  avatarTxt: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: C.white },
  nameRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm },
  name: { flexShrink: 1, fontSize: FontSize.sm, fontFamily: 'Geist_800ExtraBold', color: C.text },
  typeBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: BorderRadius.full, borderWidth: 1 },
  typeTxt: { fontSize: FontSize.xs, fontFamily: 'Geist_700Bold' },
  phone: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: C.text3, marginTop: 3 },
  ...
  metaPts: { fontSize: FontSize.xs, fontFamily: 'Geist_600SemiBold', color: C.warn },
  ...
  detailAvatarTxt: { fontSize: FontSize.xxl, fontFamily: 'Geist_800ExtraBold', color: C.white },
  detailName: { fontSize: FontSize.xl, fontFamily: 'Geist_800ExtraBold', color: C.text, textAlign: 'center' },
  ...
  kpiLabel: { fontSize: FontSize.xs, fontFamily: 'Geist_600SemiBold', color: C.text3, textTransform: 'uppercase', letterSpacing: 0.4, textAlign: 'center' },
  ...
  contactTxt: { flex: 1, fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: C.text },
  noContact: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: C.text3, textAlign: 'center', padding: Spacing.md },
  ...
  digitalCardBtnTxt: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: C.primary3 },
  ...
  actionTxt: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: C.white },
})
