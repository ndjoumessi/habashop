...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  warnTxt: { flex: 1, fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: C.text, lineHeight: 20 },
  listTitle: { fontSize: FontSize.xs, fontFamily: 'Geist_700Bold', color: C.text3, textTransform: 'uppercase', letterSpacing: 0.6, marginTop: Spacing.md },
  bullet: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm },
  bulletTxt: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: C.text2, flex: 1 },
  fieldLabel: { fontSize: FontSize.xs, fontFamily: 'Geist_700Bold', color: C.text3, marginTop: Spacing.lg, marginBottom: Spacing.xs },
  input: { backgroundColor: C.bg3, borderWidth: 1, borderColor: C.border, borderRadius: BorderRadius.md, paddingHorizontal: Spacing.md, paddingVertical: Spacing.md, fontSize: FontSize.md, fontFamily: 'Geist_400Regular', color: C.text },
