...
const s = StyleSheet.create({
  ...
  searchInput: {
    flex: 1, fontSize: FontSize.md, fontFamily: 'Geist_400Regular', color: Colors.text,
  ...
  tapCountText: { fontSize: FontSize.xs, fontFamily: 'Geist_700Bold', color: Colors.black },
  ...
  cartBadgeText: { fontSize: FontSize.xs, fontFamily: 'Geist_700Bold', color: Colors.white },
  productName: { fontSize: FontSize.xs, fontFamily: 'Geist_600SemiBold', color: Colors.text, textAlign: 'center', marginBottom: 2 },
  ...
  cartTitle: {
    fontSize: FontSize.lg, fontFamily: 'Geist_800ExtraBold', color: Colors.text,
    padding: Spacing.lg, borderBottomWidth: 1, borderBottomColor: Colors.border,
  },
  cartEmpty: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 40 },
  cartEmptyText: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: Colors.text3 },
  cartRow: {
    flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, padding: Spacing.md,
    borderBottomWidth: 1, borderBottomColor: Colors.border,
  },
  cartEmoji: { fontSize: 20, width: 28 },
  cartName: { fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: Colors.text },
  ...
  qtyBtnText: { fontSize: 16, fontFamily: 'Geist_700Bold', color: Colors.text },
  ...
  custName: { fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: Colors.text },
  custSub: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: Colors.text3, marginTop: 1 },
  custRemove: { fontSize: 14, fontFamily: 'Geist_700Bold', color: Colors.text3 },
  custBtn: {
  ...
  custBtnTxt: { fontSize: FontSize.sm, fontFamily: 'Geist_700Bold', color: Colors.primary3 },
  discountRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  discountLabel: { fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: Colors.text2 },
  discountInputWrap: {
  ...
  discountPct: { fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: Colors.text3 },
  ...
  checkoutBtnText: { fontSize: FontSize.lg, fontFamily: 'Geist_800ExtraBold', color: Colors.white },
  clearBtn: { height: 40, alignItems: 'center', justifyContent: 'center' },
  clearBtnText: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: Colors.danger },
  ...
  confirmTitle: { fontSize: FontSize.xl, fontFamily: 'Geist_800ExtraBold', color: Colors.text },
  ...
  confirmLineLabel: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: Colors.text3 },
  ...
  confirmCancelText: { fontSize: FontSize.md, fontFamily: 'Geist_600SemiBold', color: Colors.text3 },
  ...
  confirmOkText: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: Colors.white },
  ...
  pinTitle: { fontSize: FontSize.xl, fontFamily: 'Geist_800ExtraBold', color: Colors.text },
  pinInput: {
  ...
  pinCancelText: { fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: Colors.text3 },
  ...
  pinOkText: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: Colors.white },
})
