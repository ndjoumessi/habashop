...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  backIcon: { fontSize: FontSize.xl, color: C.text2, fontFamily: 'Geist_700Bold' },
  searchWrap: {
  ...
  resultTitle: { fontSize: FontSize.md, fontFamily: 'Geist_600SemiBold', color: C.text },
  resultSub: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: C.text3, marginTop: 2 },
  ...
  typeBadgeText: { fontSize: FontSize.xs, fontFamily: 'Geist_700Bold', textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  emptyText: { fontSize: FontSize.lg, fontFamily: 'Geist_700Bold', color: C.text },
  emptySubtext: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: C.text3 },
  hintWrap: { padding: Spacing.xl, alignItems: 'center', gap: Spacing.lg },
  hintText: { fontSize: FontSize.md, fontFamily: 'Geist_400Regular', color: C.text3, textAlign: 'center' },
