...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  closeBtnText: { color: C.white, fontSize: FontSize.lg, fontFamily: 'Geist_700Bold' },
  title: { color: C.white, fontSize: FontSize.xl, fontFamily: 'Geist_800ExtraBold' },
  camera: { flex: 1 },
  ...
  viewfinderLabel: {
    ...
    color: C.white, fontSize: FontSize.md, fontFamily: 'Geist_700Bold',
  ...
  scanSuccessText: { color: C.white, fontSize: 28, fontFamily: 'Geist_800ExtraBold' },
  ...
  permTitle: { fontSize: FontSize.xl, fontFamily: 'Geist_800ExtraBold', color: C.text, marginBottom: Spacing.md, textAlign: 'center' },
  permDesc: { fontSize: FontSize.md, fontFamily: 'Geist_400Regular', color: C.text3, textAlign: 'center', marginBottom: Spacing.xxl, lineHeight: 22 },
  ...
  permBtnText: { color: C.white, fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold' },
  permClose: { paddingVertical: Spacing.md },
  permCloseText: { color: C.text3, fontSize: FontSize.md, fontFamily: 'Geist_400Regular' },
})
