...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  title: { fontSize: FontSize.xl, fontFamily: 'Geist_800ExtraBold', color: C.text },
  searchWrap: {
  ...
  scanTxt: { flex: 1, fontSize: FontSize.sm, fontFamily: 'Geist_700Bold', color: C.primary3 },
  noneRow: {
    flexDirection: 'row', alignItems: 'center', gap: Spacing.sm,
    marginHorizontal: Spacing.lg, marginTop: Spacing.sm, paddingVertical: Spacing.md, paddingHorizontal: Spacing.md,
    backgroundColor: C.bg3, borderRadius: BorderRadius.md, borderWidth: 1, borderColor: C.border,
  },
  noneTxt: { flex: 1, fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: C.text2 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  empty: { textAlign: 'center', color: C.text3, fontFamily: 'Geist_400Regular', fontSize: FontSize.sm, paddingVertical: Spacing.xxxl },
  row: {
  ...
  avatarTxt: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: C.primary3 },
  name: { fontSize: FontSize.sm, fontFamily: 'Geist_700Bold', color: C.text },
  sub: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: C.text3, marginTop: 2 },
  ptsBox: { alignItems: 'center', minWidth: 38 },
  ptsVal: { fontSize: FontSize.md, fontFamily: 'JetBrainsMono_700Bold', color: C.accent2 },
  ptsLbl: { fontSize: FontSize.xs, fontFamily: 'Geist_600SemiBold', color: C.text3 },
})
