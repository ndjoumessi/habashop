...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  heroLabel: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: withAlpha('#FFFFFF', 0.7) },
  ...
  progTxt: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: withAlpha('#FFFFFF', 0.7) },
  ...
  tierCardLabel: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: C.text3 },
  tierCardVal: { fontSize: FontSize.md, fontFamily: 'Geist_700Bold', color: C.text, marginTop: 2 },
  tierCardSub: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: C.text3 },
  sectionLabel: { fontSize: FontSize.xs, fontFamily: 'Geist_600SemiBold', color: C.text3, letterSpacing: 0.5, marginBottom: Spacing.sm },
  ...
  histLabel: { fontSize: FontSize.sm, fontFamily: 'Geist_400Regular', color: C.text, flex: 1, marginRight: Spacing.sm },
  histPts: { fontSize: FontSize.sm, fontFamily: 'Geist_700Bold' },
  ...
  errorTxt: { fontSize: FontSize.sm, fontFamily: 'Geist_600SemiBold', color: C.danger, textAlign: 'center' },
  ...
  cardName: { fontSize: FontSize.xl, fontFamily: 'Geist_800ExtraBold', color: '#FFFFFF', maxWidth: 200 },
  ...
  ptsUnit: { fontSize: FontSize.md, fontFamily: 'Geist_600SemiBold', color: withAlpha('#FFFFFF', 0.6) },
  ...
  shareBtnTxt: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: C.primary },
})
