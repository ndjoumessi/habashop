...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  shopName: { fontSize: FontSize.xs, fontFamily: 'Geist_400Regular', color: withAlpha('#FFFFFF', 0.5), textTransform: 'uppercase', letterSpacing: 1 },
  ...
  statLabel: { fontSize: 10, fontFamily: 'Geist_600SemiBold', color: C.text3, textTransform: 'uppercase', letterSpacing: 0.5 },
  statValue: { fontSize: FontSize.md, fontFamily: 'Geist_800ExtraBold', color: C.text },
