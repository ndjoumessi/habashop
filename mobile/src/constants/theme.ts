...
export const DarkColors = {
  ...
  accent:   '#FFB020', accent2:  '#22C77A', accent3:  '#33B4FF',
  danger:   '#FF4D67', warn:     '#FFC53D',
  bg:       '#131011', bg2:      '#171412', bg3:      '#1C1815', bg4:      '#221D19',
  card:     '#1C1815',
  border:   'rgba(255,255,255,0.08)', border2: 'rgba(255,255,255,0.12)', border3: 'rgba(255,255,255,0.18)',
  text:     '#F5F1EC', text2:    '#C9C0B6', text3:    '#9A9082', text4:    '#524A42',
