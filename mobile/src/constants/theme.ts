...
export const DarkColors = {
  ...
  accent:   '#FFB020', accent2:  '#22C77A', accent3:  '#4F86F0',
  danger:   '#FF5C72', warn:     '#FFC53D',
  bg:       '#0A0C14', bg2:      '#0D1019', bg3:      '#11151F', bg4:      '#161C2B',
  card:     '#121724',
  border:   'rgba(255,255,255,0.06)', border2: 'rgba(255,255,255,0.11)', border3: 'rgba(124,92,255,0.28)',
