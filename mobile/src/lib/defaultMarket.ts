/**
 * MARCHÉ PAR DÉFAUT — source unique, côté MOBILE.
 *
 * ⚠️ JUMEAU À L'IDENTIQUE de `apps/frontend/src/lib/defaultMarket.ts` et `apps/backend/src/lib/defaultMarket.ts`, exercé contre
