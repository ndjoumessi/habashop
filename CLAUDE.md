...
### 🟡 Important
- **1 page > 600L à découper** (Payroll 601L ; Suppliers désormais 230L, POS 495L, HR déjà 555L). Pattern : extraire les modals + sous-composants comme déjà fait pour Stock/HR/Customers/**Orders**/**Users**/**Expenses**/**Planning**/**POS**/**Suppliers** (Users 821→219L + `components/users/` 7 fichiers ; Expenses 739→307L + `components/expenses/` 7 fichiers ; Planning 708→190L + `components/planning/` 7 fichiers ; POS 627→495L — déjà découpé, extraction écran caisse-fermée + `posTicket.ts` ; Suppliers 619→230L + `components/suppliers/` 6 fichiers + `suppliers.anchor.test.tsx` 6 cas, voir Sprint 9). **L par page**
