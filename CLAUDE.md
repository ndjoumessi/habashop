...
### Tests
- **239 tests vitest front** / 150 back (currency, pagination, components UI, anchors de découpe, logique métier pure : paie/CNSS/IRPP, dates/présences HR, libellés HR (rôle/dépt/contrat/présence/congé), conversion EUR/USD du rapport comptable, libellés catégories Stock, matrice permissions/escalade Users, lookup Open Food Facts)
