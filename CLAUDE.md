...
**Calcul `payrollBreakdown` = miroir front↔back** sur `docs/shared-fixtures/payroll-net-cases.json` : le front l'affiche avant génération, le back le fige en base. Deux exécutions ⇒ dérive possible, d'où les tests jumeaux.
