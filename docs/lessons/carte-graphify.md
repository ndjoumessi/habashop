...
| `docs/HabaShop_CDC_v3.PERIME-2026-05.docx` | CDC v3.0, « état réel du code » au 25/05/2026 | supersédé par `CLAUDE.md` + `docs/modules.md` |
...
⚠️ **Le CDC n'avait PAS de jumeau** — d'où sa conservation et son inscription en dette. Il en a
un depuis le 2026-08-07 : `docs/HabaShop_CDC_v4.md`, en markdown, **donc dans le graphe**. Le
`.docx` reste exclu comme archive périmée. *Le déclencheur « un `.docx` sans jumeau markdown plus
récent » n'a pas été franchi : il a été rendu caduc en écrivant le jumeau.*
