/**
 * MARCHÉ PAR DÉFAUT — source unique, côté BACKEND.
 *
 * ⚠️ JUMEAU À L'IDENTIQUE de `apps/frontend/src/lib/defaultMarket.ts` et `mobile/src/lib/defaultMarket.ts`, exercé contre
