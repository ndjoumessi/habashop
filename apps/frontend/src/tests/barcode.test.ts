...
import { normalizeBarcode, isValidBarcode, generateEAN13, barcodeFormat, isAcceptableBarcode, barcodeMatches, matchesScannedCode } from '@/lib/barcode'
...
// Verrouille la RÉSOLUTION d'un code scanné → produit (POS web + mobile) — G10.
