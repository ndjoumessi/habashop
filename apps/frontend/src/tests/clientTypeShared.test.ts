...
/**
 * Test JUMEAU (back ↔ front) de la règle de palier client (#215), sur les cas partagés.
 * Modifier la règle d'un seul côté fait rougir l'autre.
 */
const FIXTURE = JSON.parse(readFileSync(join(process.cwd(), '../../docs/shared-fixtures/client-type-cases.json'), 'utf8')) as {
  canonical: string[]
