...
export const LANDING_TRANSLATIONS = {
  fr: {
    ...
    footer_links: { privacy: 'Confidentialité', terms: 'CGU', contact: 'Contact' },
  },
  ...
  en: {
    ...
    footer_links: { privacy: 'Privacy', terms: 'Terms', contact: 'Contact' },
  },
  ...
  es: {
    ...
    footer_links: { privacy: 'Privacidad', terms: 'Términos', contact: 'Contacto' },
  },
  ...
  it: {
    ...
    footer_links: { privacy: 'Privacy', terms: 'Termini', contact: 'Contatto' },
  },
}
