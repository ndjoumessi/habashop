/**
 * Garde anti-INJECTION CSV — le seul endroit qui décide, côté frontend.
 *
 ...
 *
 * ⚠️ Le helper `exportCSV` (`utils/export.ts`) ne l'appelait PAS, alors qu'il est le point
 * de passage de DIX écrans (stock, clients, dépenses, paie, RH, commandes, fournisseurs,
 * rapports, activité, comptabilité). Une seule brèche, dix surfaces (#173).
 *
 * ⚠️ JUMEAU BACKEND : `apps/backend/src/lib/csv.ts` doit rester IDENTIQUE. Les deux côtés
