...
const ANALYSIS_BUTTONS = [
  ...
  { type:'hr',        icon:'👥', color:'#00B8FF', fr:'Analyse clients',      en:'Customer analysis'  },
]
...
const QUICK_QUESTIONS = {
  fr: [
    ...
    'Quels clients dois-je fidéliser en priorité ?',
  ...
  en: [
    ...
    'Which customers should I prioritize for loyalty?',
    'What is my current margin rate?',
  ],
}

const WELCOME: Record<string,string> = {
  fr: `# Bonjour ! Je suis **HabaShop AI** 👋\n\nJe suis votre assistant commercial intelligent, alimenté par **Claude** d'Anthropic.\n\n## Ce que je peux faire :\n- 📊 **Analyser vos ventes** et tendances\n- 📦 **Surveiller votre stock** et prévenir les ruptures\n- 💰 **Analyser vos finances** et calculer votre rentabilité\n- 👥 **Segmenter vos clients** et recommander des actions\n- 💡 **Répondre à toutes vos questions** sur votre business\n\nCommencez par une analyse rapide ou posez-moi une question !`,
  en: `# Hello! I'm **HabaShop AI** 👋\n\nI'm your intelligent business assistant, powered by **Claude** from Anthropic.\n\n## What I can do:\n- 📊 **Analyze your sales** and trends\n- 📦 **Monitor your stock** and prevent stockouts\n- 💰 **Analyze your finances** and calculate profitability\n- 👥 **Segment your customers** and recommend actions\n- 💡 **Answer any questions** about your business\n\nStart with a quick analysis or ask me a question!`,
}
...
export default function Forecasts() {
  ...
  const addLoadingMsg = (): string => {
    ...
    setMessages(prev => [...prev, {
      id, role:'assistant', content:'', time:new Date(), loading:true,
    }])
    return id
  }
  ...
  const sendMessage = async (messageText?: string) => {
    ...
    try {
      const data = await aiApi.chat(text, lang)
