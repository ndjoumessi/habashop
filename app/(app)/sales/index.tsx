...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  refundBtnTxt: { fontSize: FontSize.md, fontFamily: 'Outfit_800ExtraBold', color: C.danger },
  ...
  refundedTitle: { fontSize: FontSize.sm, fontFamily: 'Outfit_800ExtraBold', color: C.danger },
  refundedReason: { fontSize: FontSize.xs, fontFamily: 'Outfit_400Regular', color: C.text2, marginTop: 2, lineHeight: 16 },
